...
namespace Mt.Results.Test
{
    ...
    public sealed class MtProblemDetailsTests
    {
        ...
        public void ExceptionConstructorPositiveTest(ErrorCode code, string message, string expected)
        {
        ...
        public void ExceptionConstructorNegativeTest(MtException exception, Type expected)
        {
